...
print("✅ Clé API chargée :", "Oui" if OPENAI_API_KEY else "Non")


ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "bmc.pythonanywhere.com").split(",")
...
# ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "bmc.pythonanywhere").split(",")
