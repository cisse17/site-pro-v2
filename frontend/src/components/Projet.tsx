...
const Projet = () => {
  ...
  useEffect(() => {
    ...
    axios.get(getMediaUrl("/api/projet/")).then((res) => {
      setProjects(res.data);
    });
  }, []);

  const filteredProjets = Projets.filter((projet) => {
    const matchName = projet.titre
      .toLowerCase()
  ...
  return (
    <div className="pt-20 md:pt-24 pb-16 px-4 min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Filtres */}
        <div
          className="flex flex-col md:flex-row gap-4 mb-10 justify-center"
          data-aos="fade-down"
        >
          <input
            type="text"
